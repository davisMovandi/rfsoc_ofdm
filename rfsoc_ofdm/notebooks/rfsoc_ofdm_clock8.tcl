...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net rfdc_clk_dac3 [get_bd_pins InspectorTransmitter/aclk] [get_bd_pins axi_interconnect_hp2/ACLK] [get_bd_pins axi_interconnect_hp2/M00_ACLK] [get_bd_pins axi_interconnect_hp2/S00_ACLK] [get_bd_pins ofdm_interpolator/aclk] [get_bd_pins ofdm_transmitter/AXI4_Lite_ACLK] [get_bd_pins ofdm_transmitter/IPCORE_CLK] [get_bd_pins proc_sys_reset_clk_dac_2/slowest_sync_clk] [get_bd_pins ps8_axi_periph/M01_ACLK] [get_bd_pins ps8_axi_periph/M05_ACLK] [get_bd_pins ps8_axi_periph/M07_ACLK] [get_bd_pins ps8_axi_periph/M08_ACLK] [get_bd_pins ps8_axi_periph/M09_ACLK] [get_bd_pins rfdc/clk_dac2] [get_bd_pins rfdc/s2_axis_aclk] [get_bd_pins zynq_ultra_ps_e/saxihp2_fpd_aclk]
